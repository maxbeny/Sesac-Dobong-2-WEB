...
// hellWorld3() err! 선언되기 전에 호출 불가능합니다.
const hellWorld3 =function (){
    console.log('hello world 3')
}

hellWorld3()

// hellWorld4() err! 선언되기 전에 호출 불가능합니다.
const hellWorld4 = () => {
...
const sayHelloVallue = sayHello4("hello", 'max')
console.log(sayHelloVallue)